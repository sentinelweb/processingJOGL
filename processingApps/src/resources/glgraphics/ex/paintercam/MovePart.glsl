...
uniform vec2 par_vec21;          // Maximum position
uniform int par_int1;            // Follow gradient
uniform float par_flt1;          // Mean velocity
uniform float par_flt2;          // Noise magnitude
