...
uniform int par_int1;            // Maximum brush length
uniform float par_flt1;          // New image coefficient
uniform float par_flt2;          // Color change fraction
uniform float par_flt3;          // Color change power
...
void main(void)
{
    ...
    bool color_chg = (0.0 <= par_flt1) && (par_flt1 <= 1.0);
	...
	int max_count = int(count_vec.y * float(par_int1));
