package net.processing.glgraphics.ex.basic;
...
public class Basic extends PApplet{
	...
	public void setup()
	{
	    ...
	    tex0 = new GLTexture(this, "resources/glgraphics/ex/basic/milan_rubbish.jpg");
	    ...
	    pulseEmboss = new GLTextureFilter(this, "resources/glgraphics/ex/basic/pulsatingEmboss.xml");
	    
	    img = new PImage(tex0.width, tex0.height);
	    
	    font = loadFont("resources/glgraphics/ex/basic/EstrangeloEdessa-24.vlw");
	    textFont(font, 24);
	...
	public void keyPressed()
	{
	    if (key == CODED) 
	    {
	        if (keyCode == UP) 
	        {
	            fade = constrain(fade + 0.01f, 0.0f, 1.0f);
	        } 
