...
public class ColourSorting extends PApplet {
	...
	public void setup() {
	  ...
	  for (int i = 0; i < count; i++) {
	    captureColors[i] = new Tuple(this);
	    drawColors[i] = new Tuple(this, 0.5f, 0.5f, 0.5f);
	  }
	}
	...
	public void draw() {
	  if (video.available()) {
	    ...
	    for (int i = 0; i < index; i++) {
	      drawColors[i].target(captureColors[i], 0.1f);
	      drawColors[i].phil();
