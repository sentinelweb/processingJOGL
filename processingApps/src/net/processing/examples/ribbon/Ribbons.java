package net.processing.examples.ribbon;
/**
...
public class Ribbons extends PApplet {
	...
	public void draw() {
	    ...
	    //cam motion
	    camera1.feed();
	    camera1.circle(0.002f);

	    //use additive blending for OPENGL
	    ...
	    if( SAVING ){
	        saveFrame( "images3/image_" + saveCount + ".png" );
	        saveCount ++;
	    }
	...
	public class Ribbon { 
	    ...
	    public  Ribbon(float pcolor, float width){
	        ribbonColor = pcolor;
	        ribbonWidth = width;
