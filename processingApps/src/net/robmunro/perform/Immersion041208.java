 ...
 * 
 * PERFORMED AT : Immersion, 04th December, 2008. Normal - screen
 * PERFORMED AT : VJ London, 18th December, 2008. Wide - screen
 * @author robm
 *
 */
public class Immersion041208 extends PApplet {
	...
	private void drawMode(int mode) {
		if (mode==1) {
			...
			Vector3D v = new Vector3D(  800,-200,-700.0f);
			gl.glTranslatef( v.x, v.y, v.z);
			...
			Vector3D v = new Vector3D(  -700,0,-300.0f);
			gl.glTranslatef( v.x, v.y, v.z);
			...
			if (mode==6) {
				...
				Vector3D v = new Vector3D(  -400,0,-180.0f);
				gl.glTranslatef( v.x, v.y, v.z);
	...
	public static void main (String[] args) {
		println( Immersion041208.class.getCanonicalName());
		PApplet.main(new String[] { Immersion041208.class.getCanonicalName() });
	}
