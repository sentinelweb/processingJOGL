...
/**
 *  * PERFORMED AT :Placard 20 Sept 08, Cafe OTO.
 * @author robm
 *
 */
public class Placard200908 extends PApplet {
	...
	public void setup() {
		...
		//size(800,600, OPENGL);
		 ...
		 mblur.clearAccum();
		  ...
		  try {
			whiteTex = TextureIO.newTexture(ImageIO.read(Placard200908.class.getResource("/resources/robmunro/white.gif")), true);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void main (String[] args) {
		...
		Placard200908 p = new Placard200908();
