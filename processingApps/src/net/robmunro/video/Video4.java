 ...
 * 
 * PERFORMED AT : VJ London, 18th December, 2008. Wide - screen (4:1 aspect)
 * @author robm
 *
 */
public class Video4 extends PApplet {
	...
	public static void main (String[] args) {
		println( Video4.class.getCanonicalName());
		PApplet.main(new String[] { Video4.class.getCanonicalName() });
	}
