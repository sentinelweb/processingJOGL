...
public class UsingGLSLShader
    ...
    public void setup() {
        ...
        for (int x = 0; x < myNumberOfPlanes; x++) {
            for (int y = 0; y < myNumberOfPlanes; y++) {
                ...
                myShadedPlane.material().addPlugin(new ShaderMaterial());
    ...
    private class ShaderMaterial
        ...
        public void begin(GLContext theRenderContext, Material theParent) {
            ...
            //_myShaderManager.setUniform(_myShaderProgram, "myColor", (float) Math.random());
            _myShaderManager.setUniform(_myShaderProgram, "myX", (float) Math.random() * 100f - 50f);
            _myShaderManager.setUniform(_myShaderProgram, "myY", (float) Math.random() * 100f - 50f);
        }
