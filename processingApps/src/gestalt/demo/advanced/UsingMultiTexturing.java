...
public class UsingMultiTexturing
    ...
    private class MultiTexturedPlane
        ...
        private JoglTexturePlugin _myImageTexture;

        private JoglTexturePlugin _myMaskTexture;
        ...
        public MultiTexturedPlane() {
            /* image texture */
            _myImageTexture = (JoglTexturePlugin) drawablefactory().texture();
            _myImageTexture.setFilterType(TEXTURE_FILTERTYPE_LINEAR);
            _myImageTexture.load(bitmapfactory().getBitmap(Resource.getStream("demo/common/auto.png")));

            /* mask texture */
            _myMaskTexture = (JoglTexturePlugin) drawablefactory().texture();
            _myMaskTexture.setFilterType(TEXTURE_FILTERTYPE_LINEAR);
            _myMaskTexture.load(bitmapfactory().getBitmap(Resource.getStream("demo/common/mask256.png")));
        }
