...
import gestalt.impl.jogl.model.JoglBoundingBoxView;


public class UsingOBJModelLoader extends AnimatorRenderer {
    ...
    public void setup() {
        ...
        BoundingBoxView myBBox = new JoglBoundingBoxView(myModel.getBoundingBoxData());
         ...
         * counterclockwise and cinema4d exports clockwise. it there are no
        ...
        myTexture.load(bitmapfactory().getBitmap(Resource.getPath("demo/common/vignet.png")));
