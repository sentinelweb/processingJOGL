...
import gestalt.applet.JoglAppletRenderer;
...
/**
 * this demo shows source code for using gestalt as an applet.
 * note that there are some caveats when using gestalt/jogl in
 * a browser.
 * one is that you need retrieve data with an inputstream.
 * anther one is that the native part of jogl needs to be installed
 * on the clients virtual machine.
 *
 * sample code for an applet:
 *
...
public class UsingAppletRenderer
    extends JoglAppletRenderer {
