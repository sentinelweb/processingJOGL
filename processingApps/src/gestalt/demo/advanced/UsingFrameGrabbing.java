...
public class UsingFrameGrabbing
    ...
    public void setup() {
        ...
        _myFontProducer = bitmapfactory().getFontProducer(Resource.getStream("demo/font/silkscreen/slkscr.ttf"));
        _myFontProducer.setSize(48);
        _myFontProducer.setLineWidth(18);
        _myFontProducer.setQuality(FontProducer.FONT_QUALITY_HIGH);
         ...
         */
        _myFrameGrabber.setImageFileFormat(IMAGE_FILEFORMAT_JPEG);
